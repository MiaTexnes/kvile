...
export function SiteHeader({ variant, className }: { variant: Variant; className?: string }) {
            ...
            <>
              ...
              <Link
                ...
                className={clsx(
                  ...
                  isOverlay && 'border-stone-200/90 bg-white/80 supports-[backdrop-filter]:bg-white/70',
                )}
              ...
              >
                ...
                <span className="flex min-w-0 flex-col leading-tight font-manrope">
                  ...
                  <span className="truncate text-sm font-semibold text-stone-900">{user.name}</span>
                </span>
              </Link>
              <button
                type="button"
